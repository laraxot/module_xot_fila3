...
class IndexStoreAttachJob extends XotBaseJob {
    public function handle(): PanelContract {
        ...
        //$this->panel->getRows()->attach($this->data['groups']['to']);
        //return 'preso';
        ...
        $items_0 = $this->panel->getRows()->get()->pluck($items_key);
        ...
        $this->panel->getRows()->detach($items_sub->all());
        $this->panel->getRows()->attach($items_add->all());
