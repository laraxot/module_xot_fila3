...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(mix('css/main.css', 'module_xot/assets/build')); ?>">
    ...
    <body class="flex flex-col justify-between min-h-screen bg-gray-100 text-gray-800 leading-normal font-sans">
        ...
        <script src="<?php echo e(mix('js/main.js', 'module_xot/assets/build')); ?>"></script>
...
<?php /**PATH /var/www/html/staging.mediamonitor.it/laravel/Modules/Xot/docs/source/_layouts/master.blade.php ENDPATH**/ ?>